      ...
      <div className='flex'>
        <button
          ...
          className={clsx({
            ...
            'bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700': !isDisabled,
            ...
            'transform hover:cursor-pointer hover:scale-[1.02] active:scale-[0.98]': !isDisabled,
          })}
