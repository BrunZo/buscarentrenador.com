...
export default function Home() {
  return (
    <div className='animate-fade-in'>
      {/* Hero Section */}
      <div className='relative overflow-hidden rounded-2xl bg-gradient-hero p-0 sm:p-8 md:p-12 mb-12 shadow-large'>
        <div className='relative z-10'>
          <h1 className='text-3xl sm:text-4xl md:text-5xl font-bold gradient-text mb-4'>
            Buscarentrenador.com
          </h1>
          <p className='text-lg sm:text-xl md:text-2xl gradient-text mb-6 max-w-2xl'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-12'>
        <div className='bg-white rounded-xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-1 border border-gray-100'>
          <div className='w-12 h-12 bg-linear-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center mb-4'>
        ...
        <div className='bg-white rounded-xl p-6 shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-1 border border-gray-100'>
          <div className='w-12 h-12 bg-linear-to-br from-pink-500 to-rose-600 rounded-lg flex items-center justify-center mb-4'>
            <svg className='w-6 h-6 text-white' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
